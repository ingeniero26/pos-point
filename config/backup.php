...
return [
    ...
    'backup' => [
        ...
        'database_dump_filename_base' => 'database_backup',
        ...
        'destination' => [
            ...
            /*
             * The compression method to be used for the backup zip file.
             * 
             * Options:
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => 'admin@pos-point.com',

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'ingjerson2014@gmail.com'),
