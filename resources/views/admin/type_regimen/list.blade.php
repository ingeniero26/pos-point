                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <h3 class="card-title">Listado de Tipo Régimen</h3>
                                <div class="card-tools">
                                    <ul class="pagination pagination-sm float-end">
                                        <a href="" class="btn btn-sm btn-primary"
                                         data-bs-toggle="modal" data-bs-target="#addCustomerModal">
                                         Agregar Tipo Régimen
                                        </a>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="modal-body">
                    ...
                    <form id="addCustomerForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="contact_name" class="form-label"><b>Código</b></label>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="regimen_name" name="regimen_name" required>
                                </div>
                            </div>
...
$(document).ready(function() {
    ...
    $(' #filterStatus').change(function() {
        ...
        function handleToggleStatus(e) {
            ...
            $.ajax({
                url: "{{ url('admin/type_regimen/toggle-status') }}/" + customerId,
                type: 'PUT',
                data: {
                    _token: "{{ csrf_token() }}",
                    status: newStatus
    ...
    $.ajax({
        url: "{{ url('admin/type_regimen/edit') }}/" + customerId,
        type: 'GET',
        success: function(customer) { 
            ...
            $('#regimen_name').val(customer.regimen_name);    
            ...
            $('#addCustomerForm').off('submit').on('submit', function(e) {
                ...
                $.ajax({ 
                    url: "{{ url('admin/type_regimen/update') }}/" + customerId,
                    type: 'POST',
                    data: formData,
                    success: function(response) {
...
function handleDelete(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ url('admin/type_regimen/delete') }}/" + customerId,
                        type: 'DELETE',
                        data: {
                            _token: "{{ csrf_token() }}"
                        },
