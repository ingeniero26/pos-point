    ...
    <main class="app-main"> 
        <div class="app-content-header"> 
            <div class="container-fluid"> 
                <div class="row">
                    <div class="col-sm-6">
                        <h3 class="mb-0">Prioriodades de Oportunidades</h3>
                    </div>
                    <div class="col-sm-6">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addMeasureModalLabel">Agregar Prioridad</h5>
                ...
                <div class="modal-body">
                    <form id="addMeasureForm">
                        ...
                        <div class="mb-3">
                            <label for="measureName" class="form-label"><b>Nombre </b></label>
                            <input type="text" class="form-control" id="name" name="name" required>
                        </div>
                        <div class="mb-3">
                            <label for="">Color</label>
                            <input type="color" name="color" id="color" class="form-comtrol">
                        </div>
                        <div class="mb-3">
   ...
   <script type="text/javascript">
        $(document).ready(function(){
            ...
            function fectMeasures(){
                $.ajax({
                    url: "{{url('admin/opportunity_priority/data')}}",
                    type: 'GET',
                      ...
                      $('#addMeasureModal').modal('show'); // Manejar el envío del formulario de edición
                       $('#addMeasureForm').off('submit').on('submit', function(e) {
                         ...
                         const formData = $(this).serialize();
                          $.ajax({ url: "{{ url('admin/opportunity_priority/update') }}/" + measureId, 
                          type: 'POST', 
                          data: formData,
                           success: function(response)
