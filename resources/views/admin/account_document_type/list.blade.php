@extends('layouts.app')
                                ...
                                <div class="card-tools">
                                    <ul class="pagination pagination-sm float-end">
                                        <a href="" class="btn btn-sm btn-primary"
                                         data-bs-toggle="modal" data-bs-target="#addAccountingDocumentModal">
                                            Agregar Documentos Contable
                                        </a>
                                    </ul>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="addAccountingDocumentModal" tabindex="-1" aria-labelledby="addAccountingDocumentModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addAccountingDocumentModalLabel">Agregar Documento Contable</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="addAccountingDocumentForm">
                        {{ @csrf_field() }}
   ...
   <script type="text/javascript">
    ...
    $.ajax({
        url: "{{ url('admin/account_document_type/data') }}",
        type: 'GET',
                      ...
                      $('#addAccountingDocumentModal').modal('show'); // Manejar el envío del formulario de edición
                       $('#addAccountingDocumentForm').off('submit').on('submit', function(e) {
                         ...
                         const formData = $(this).serialize();
                          $.ajax({ url: "{{ url('admin/account_document_type/update') }}/" +account_document_typeId, 
                          type: 'POST', 
                          data: formData,
                           success: function(response)
