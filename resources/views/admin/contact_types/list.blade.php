    ...
    <main class="app-main"> 
        <div class="app-content-header"> 
            <div class="container-fluid"> 
                <div class="row">
                    <div class="col-sm-6">
                        <h3 class="mb-0">Tipo Contactos</h3>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <form id="addAccountBankForm" >
                        @csrf
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="color" id="colour" name="colour" class="form-control" required>
                            </div>
   ...
   <script type="text/javascript">
    ...
    fechtAccountBank();
        ...
        function fechtAccountBank(){
            $.ajax({
                url: "{{route('admin.contact_type.fetch')}}",
                type: 'GET',
                success: function(response){
                    ...
                    $.each(response, function(index, account_bank){
                        ...
                        tableBody += `<tr>
                                        ...
                                        <td style="background-color: ${account_bank.colour}; width: 50px;"></td>
        ...
        function handleToggleStatus(e) {
            ...
            $.ajax({
                url: "{{ url('admin/contact_types/toggle-status') }}/" + cityId,
                type: 'PUT',
                data: {
                    _token: "{{ csrf_token() }}",
                    status: newStatus
        ...
        function handleEdit(e) {
         ...
         $.ajax({
        url: "{{ url('admin/contact_types/edit') }}/" + account_bankId,
           type: 'GET',
        success: function(city) { 
            ...
            $('#addAccountBankForm').off('submit').on('submit', function(e) {
                ...
                $.ajax({ 
                    url: "{{ url('admin/contact_types/update') }}/" + account_bankId,
                    type: 'POST',
                    data: formData,
                    success: function(response) {
 ...
 function handleDelete(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "{{ url('admin/contact_types/delete') }}/" + colorId,
                    type: 'DELETE',
                    data: {
                        _token: "{{ csrf_token() }}"
                    },
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#addAccountBankForm').on('submit', function (e){
            ...
            $.ajax({
                url: "{{route('admin.contact_type.store')}}",
                type: 'POST',
                data: formData,
                success: function(response){
                    $('#addAccountBankModal').modal('hide');
