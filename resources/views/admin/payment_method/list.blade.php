@extends('layouts.app')
    ...
    <main class="app-main"> 
        <div class="app-content-header"> 
            <div class="container-fluid"> 
                <div class="row">
                    <div class="col-sm-6">
                        <h3 class="mb-0">Metodos de Pago</h3>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Listado de Tipo Producttos </h3>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addItemTypeForm">
                        {{ @csrf_field() }}
                        <div class="mb-3">
                            <label for="taxCode" class="form-label"><b>Código</b></label>
                        ...
                        <div class="mb-3">
                            <label for="taxDescription" class="form-label"><b>Dia</b></label>
   ...
   <script type="text/javascript">
    ...
    $.ajax({
        url: "{{ url('admin/payment_method/data') }}",
        type: 'GET',
        ...
        error: function (xhr, status, error) {
            ...
            function handleEdit(e) {
                ...
                let items_typeId = $(this).data('id');
                 $.ajax({
                     url: "{{ url('admin/payment_method/edit') }}/" + items_typeId,
                  type: 'GET',
                      ...
                      $('#addItemTypeModal').modal('show'); // Manejar el envío del formulario de edición
                       $('#addItemTypeForm').off('submit').on('submit', function(e) {
                         ...
                         const formData = $(this).serialize();
                          $.ajax({ url: "{{ url('admin/payment_method/update') }}/" + items_typeId, 
                          type: 'POST', 
                          data: formData,
                           success: function(response)
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ url('admin/payment_method/delete') }}/" + items_typeId,
                        type: 'DELETE',
                        data: {
                            _token: "{{ csrf_token() }}"
                        },
...
$(document).ready(function() {
   ...
   $(document).ready(function(){
    $('#addItemTypeForm').on('submit', function (e){
        ...
        $.ajax({
            url: "{{ url('admin/payment_method/store') }}",
            type: 'POST',
            data: formData,
            success: function(response){
                $('#addItemTypeModal').modal('hide');
