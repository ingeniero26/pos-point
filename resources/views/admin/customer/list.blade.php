@extends('layouts.app')
                ...
                <div class="modal-body">
                    ...
                    <form id="addCustomerForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="contact_name" class="form-label"><b>Nombre del Cliente</b></label>
   ...
   function duplicateIdentification(input) {
    ...
    if (identification_number) {
        $.ajax({
            url: '{{ url('admin/customer/check-identification') }}',
            type: 'POST',
            data: {
                _token: '{{ csrf_token() }}',
    ...
    if (email) {
        $.ajax({
            url: '{{ url('admin/customer/check-email') }}',
            type: 'POST',
            data: {
                _token: '{{ csrf_token() }}',
                email: email
...
$(document).ready(function() {
    ...
    $(' #filterStatus').change(function() {
        ...
        function handleToggleStatus(e) {
            ...
            $.ajax({
                url: "{{ url('admin/customer/toggle-status') }}/" + customerId,
                type: 'PUT',
                data: {
                    _token: "{{ csrf_token() }}",
                    status: newStatus
        ...
        function handleView(e)
        {
            ...
            window.location.href = "{{ url('admin/customer') }}/" + customerId;
        }
        ...
        success: function(customer) { 
           ...
           $('#email').val(customer.email);
            ...
            $('#addCustomerForm').off('submit').on('submit', function(e) {
                ...
                $.ajax({ 
                    url: "{{ url('admin/customer/update') }}/" + customerId,
                    type: 'POST',
                    data: formData,
                    success: function(response) {
