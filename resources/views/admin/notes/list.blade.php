...
<main class="app-main">
    <div class="app-content-header"> 
        <div class="container-fluid"> 
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">Notas de Crédito y Débito</h3>
                </div>
                <div class="col-sm-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="btn-group float-end">
                                        ...
                                        <button type="button" id="exportPdf" class="btn btn-danger" onclick="exportPdf()">
...
<script>
    ...
    function loadSales(filters = {}) {
        ...
        $.ajax({
            ...
            success: function(data) {
                    ...
                    var row = `<tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <button class="btn btn-success btn-sm send-email" data-sale-id="${sale.id}" title="Enviar">
                ...
                // Inicializar eventos para botones dinámicos
                $(document).on('click', '.send-email', handleSendEmail);
            },
    ...
    $(document).ready(function() {
        // Evento click para el botón de detalles
        $(document).on('click', '.details-sale', function() {
    ...
    // Manejar envio de correo
    function handleSendEmail() {
        var saleId = $(this).data('sale-id');
        
        Swal.fire({
            title: 'Enviar factura por correo',
            text: '¿Está seguro de enviar la factura por correo electrónico?',
            icon: 'question',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "{{ url('admin/sales/send-email') }}" + '/' + saleId,
                    method: 'POST',
                    data: {
                        _token: "{{ csrf_token() }}",
                        sale_id: saleId
    ...
    // funcion para notas de credito
    $(document).on('click', '.notes-credit', function() {
        var saleId = $(this).data('sale-id');
        window.location.href = "{{ url('admin/notes_credit/add') }}/" + saleId;
    });
    ...
    function exportPdf() {
        ...
        var url = '{{ route("admin.sales.export.pdf") }}';
        var params = [];
