...
@section('title', 'Crear Etapa de Oportunidad')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title">Crear Nueva Etapa de Oportunidad</h3>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.opportunity_stage.store') }}" method="POST" id="stageForm">
                        @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" 
                                               ...
                                               value="{{ old('closing_percentage', 0) }}" 
                                               min="0" 
                                               max="100" 
                                               step="0.01"
                                               required>
